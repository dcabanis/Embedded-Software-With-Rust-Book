...
This example covers *bindgen* to generate Rust FFI bindings automatically instead of hand-writing them, against a real third-party C library rather than the chapter's own `example.h`, on the STM32F103RBT6 (NUCLEO-F103RB).
