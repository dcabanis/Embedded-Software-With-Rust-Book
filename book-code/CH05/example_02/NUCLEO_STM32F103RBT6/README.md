# example_02  Type-safe MMIO via PAC (stm32f1) on the NUCLEO-F103RB
...
eliminating raw pointer casts while producing the same result: PA5 (active-high,
LED LD2) toggled every second via SysTick.
