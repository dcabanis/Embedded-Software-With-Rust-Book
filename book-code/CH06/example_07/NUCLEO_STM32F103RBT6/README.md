...
This example demonstrates the full GDB + OpenOCD debugging workflow on the
STM32F103RBT6 (NUCLEO-F103RB), including an automated `.gdbinit` that
connects to the target, flashes the binary, and stops at `main` ready for
interactive use.
